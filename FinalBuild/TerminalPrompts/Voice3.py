...
class Voice3:
    ...
    def __init__(self):
        ...
        if (self.__temp == 1):
            ...
            SelectWave(UserInput.VOICE3.value)
        elif (self.__temp == 3):
            SelectFilterPos(UserInput.VOICE3.value)
        #Tells Router to toggle isActive state.
        elif (self.__temp == 4):
            Router(UserInput.VOICE3.value, UserInput.TOGGLE.value)
        #Tells Router to remove selected voice.
        elif (self.__temp == 5):
            Router(UserInput.VOICE3.value, UserInput.REMOVE.value)
        else:
            pass
