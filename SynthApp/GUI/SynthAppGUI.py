...
from GUI.SignUpDialog import SignUpDialog
from GUI.SaveDatabaseDialog import SaveDatabaseDialog
...
class MyFrame(wx.Frame):
    ...
    def saveCloud(self, event):
        if (ConfigLoad.userLoggedIn.getLoggedIn() == Bools.TBOOL.value):
